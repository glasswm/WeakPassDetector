...
bSizer_Panel111.Add(m_Label_IP,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel111.Add(m_Text_IP,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel112.Add(m_Label_Port,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel112.Add(m_Text_Port,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel113.Add(m_Label_DBType,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel113.Add(m_Choice_DBType,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel114.Add(m_Label_Cyptype,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel114.Add(m_Choice_Cyptype,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel121.Add(m_Label_DBname,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel121.Add(m_Text_DBname,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel122.Add(m_Label_Sheetname,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel122.Add(m_Text_Sheetname,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel123.Add(m_Label_Username,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel123.Add(m_Text_Username,proportion=1,flag=wx.RIGHT,border=15)
...
bSizer_Panel124.Add(m_Label_Pswname,proportion=1,flag=wx.LEFT,border=15)
bSizer_Panel124.Add(m_Text_Pswname,proportion=1,flag=wx.RIGHT,border=15)
...
# m_Panel214 = wx.Panel(m_Panel21)
# m_Panel215 = wx.Panel(m_Panel21)
...
# bSizer_Panel21.Add(m_Panel214,proportion=1,flag=wx.EXPAND)
# bSizer_Panel21.Add(m_Panel215,proportion=1,flag=wx.EXPAND)


m_Panel21.SetSizer(bSizer_Panel21)
# bSizer_Panel21.AddGrowableCol(6)
# bSizer_Panel21.AddGrowableRow(0)
# bSizer_Panel21.Add(bt_Start,(0,30),(1,1),wx.EXPAND)
# m_Panel21.SetSizer(bSizer_Panel21)
